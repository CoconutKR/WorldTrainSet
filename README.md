# World Train Set 세계열차세트
**세계열차세트**는 세계 각국의 열차 차량을 추가해주는 OpenTTD NewGRF입니다.  
게임 내 온라인 콘텐츠에서 다운로드하거나, [Github release 페이지](https://github.com/GBLINER/WorldTrainSet/releases)에서 다운로드할 수 있습니다.
...
## 자료제공
본 세계열차세트는 YST에서 분리된 GRF로 일부 스프라이트는 YST에서 제작되었습니다.
